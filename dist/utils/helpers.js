...
function generateSlug(text = null) {
...
function formatDate(date, useAgo = false, format = 'LL') {
    return useAgo ? (0, moment_1.default)(date).fromNow() : (0, moment_1.default)(date).format(format);
}
exports.formatDate = formatDate;
function encodeHTMLEntities(str) {
    return String(str).replace(/&laquo;/g, '«').replace(/&raquo;/g, '»');
}
...
function formatMailTo(job) {
    return `mailto:${job.application_email}?subject=Application for the role of ${job.job_title}&body=Dear Hiring Manager,%0D%0A%0D%0AI would like to apply for the role of ${job.job_title} as described on ${job.job_url}.%0D%0A%0D%0A Best Regards,`;
}
exports.formatMailTo = formatMailTo;
exports.nairaSymbol = "₦";
...
const sleep = (seconds = 10000) => __awaiter(void 0, void 0, void 0, function* () {
